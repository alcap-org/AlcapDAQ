...
static const char *hostname = "cheetah";
//static const char *hostname = "khan";
...
TObject *get_hist( const char *name, const int run_nr = 0, TFile *fin=NULL) 
{
  ...
  char fin_name[256];
  sprintf(fin_name,"../root/%05d.root",run_nr);
  //TFile *fin;
