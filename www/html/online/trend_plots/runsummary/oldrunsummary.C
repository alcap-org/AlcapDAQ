...
void runsummary()
{
  ...
  THStack * RunSummary= new THStack("RunSummary","Data Taken w.r.t Run Summary");
  ...
  RunSummary->Draw("nostack");
    ...
    RunSummary->GetXaxis()->SetTitle("Run Summary");
    RunSummary->GetYaxis()->SetTitle("muons");
    ...
    hq->GetXaxis()->SetTitle("Run Summary");
    ...
    hag->GetXaxis()->SetTitle("Run Summary");
    ...
    hak->GetXaxis()->SetTitle("Run Summary");
