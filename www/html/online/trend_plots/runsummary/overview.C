...
void overview()
{
  ...
  ***/
  ...
  s_stat_info stat_Quartz, stat_Ag;
  ...
  *os << " <tr align='center'><td>Ag</td><td>left</td><td>"  << fixed << stat_Ag.nmuons[0] << "&times;10<sup>10</sup></td>" << "</td><td>"<< stat_Ag.nruns[0] << "</td><td>" << stat_Ag.nhours[0] <<  "</td></tr>"
      << " <tr align='center'><td>Ag</td><td>right</td><td>" << fixed << stat_Ag.nmuons[1] << "&times;10<sup>10</sup></td>" << "</td><td>"<< stat_Ag.nruns[1] << "</td><td>" << stat_Ag.nhours[1] <<  "</td></tr>"
      << " <tr align='center'><td>Ag</td><td>up</td><td>"    << fixed << stat_Ag.nmuons[2] << "&times;10<sup>10</sup></td>" << "</td><td>"<< stat_Ag.nruns[2] << "</td><td>" << stat_Ag.nhours[2] <<  "</td></tr>"
      << " <tr align='center'><td>Ag</td><td>down</td><td>"  << fixed << stat_Ag.nmuons[3] << "&times;10<sup>10</sup></td>" << "</td><td>"<< stat_Ag.nruns[3] << "</td><td>" << stat_Ag.nhours[3] <<  "</td></tr>";
  
  *os << " <tr align='center'><td> Quartz </td><td>left</td><td>"  << fixed << stat_Quartz.nmuons[0] << "&times;10<sup>10</sup></td>" << "</td><td>"<< stat_Quartz.nruns[0] << "</td><td>" << stat_Quartz.nhours[0] <<  "</td></tr>"
      << " <tr align='center'><td> Quartz </td><td>right</td><td>" << fixed << stat_Quartz.nmuons[1] << "&times;10<sup>10</sup></td>" << "</td><td>"<< stat_Quartz.nruns[1] << "</td><td>" << stat_Quartz.nhours[1] <<  "</td></tr>"
      << " <tr align='center'><td> Quartz </td><td>up</td><td>"    << fixed << stat_Quartz.nmuons[2] << "&times;10<sup>10</sup></td>" << "</td><td>"<< stat_Quartz.nruns[2] << "</td><td>" << stat_Quartz.nhours[2] <<  "</td></tr>"
      << " <tr align='center'><td> Quartz </td><td>down</td><td>"  << fixed << stat_Quartz.nmuons[3] << "&times;10<sup>10</sup></td>" << "</td><td>"<< stat_Quartz.nruns[3] << "</td><td>" << stat_Quartz.nhours[3] <<  "</td></tr>"
      << "</table>"
      << endl;
