...
if ( $mode == "view" ) {
  ...
  echo "Date: <b>$SHIFT_DATE</b>, Daytime: <b>$cdaytime[$SHIFT_DAYTIME]</b> &nbsp;&nbsp;&nbsp;&nbsp;";
...
Magnet setting: <INPUT type="text" name="SEPARATOR_MAGNET" maxlength="10" size="10" value="$SEPARATOR_MAGNET" $disabled> (920 w/HV at 185. See also eLog <a href="http://www.npl.uiuc.edu/elog/mulan/Summer2007/154" target="aux">154</a>)<br>
