/****************************************************************************
** $Id: helpwindow.cpp,v 1.1.1.1 2005/06/20 23:37:13 mucap Exp $
**
...
//as    file->insertItem( tr("E&xit"), qApp, SLOT( closeAllWindows() ), CTRL+Key_X );
    ...
    QIconSet icon_back( QPixmap("help/back.xpm") );
    QIconSet icon_forward( QPixmap("help/forward.xpm") );
    QIconSet icon_home( QPixmap("help/home.xpm") );
