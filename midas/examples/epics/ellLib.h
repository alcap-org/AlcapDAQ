/* ellLib.h  $Id: ellLib.h,v 1.1.1.1 2005/06/20 23:37:10 mucap Exp $
 *
...
#define	ellPrevious(PNODE)	(((ELLNODE *)(PNODE))->previous)
   ...
   epicsShareFunc void epicsShareAPI ellExtract(ELLLIST * pSrcList, ELLNODE * pStartNode,
                                                ELLNODE * pEndNode, ELLLIST * pDstList);
   epicsShareFunc ELLNODE *epicsShareAPI ellGet(ELLLIST * pList);
   epicsShareFunc void epicsShareAPI ellInsert(ELLLIST * plist, ELLNODE * pPrev,
                                               ELLNODE * pNode);
