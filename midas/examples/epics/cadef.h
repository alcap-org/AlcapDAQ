...
#endif /*HDRVERSIONID*/
   HDRVERSIONID(cadefh, "@(#) $Id: cadef.h,v 1.1.1.1 2005/06/20 23:37:10 mucap Exp $")
...
#ifdef CAC_FUNC_PROTO
                                              CAFDHANDLER * pHandler, void *pArg
#endif                          /*CAC_FUNC_PROTO */
       );
...
#ifdef CAC_FUNC_PROTO
                                   CA_SYNC_GID gid, ca_real timeout
#endif                          /*CAC_FUNC_PROTO */
       );
...
#if defined(CAC_FUNC_PROTO) && !defined(CA_DONT_INCLUDE_STDARGH)
   int epicsShareAPI
       ca_replace_printf_handler(int (*ca_printf_func) (const char *pformat, va_list args)
       );
#else                           /*CAC_FUNC_PROTO */
