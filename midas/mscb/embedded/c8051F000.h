...
; 	TARGET MCU	: C8051Fxxx (C8051 System Controller)
...
sfr DSRFLG = 0x97;              /* DSR FLAG REGISTER                                       */
...
sfr DSRL = 0xB3;                /* DSR PORT - LOW BYTE                                     */
sfr DSRH = 0xB4;                /* DSR PORT - HIGH BYTE                                    */
