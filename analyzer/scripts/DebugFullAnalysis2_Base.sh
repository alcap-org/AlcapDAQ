...
DataDirTree="/data/ckampa/AlCap_2015a/output_debug" # 03-08-24 adding TDC processing and IdentitySyncPulses
DataDir="/data/ckampa/AlCap_2015a/output_debug2" # 03-08-24 adding TDC processing and IdentitySyncPulses
mkdir -p $DataDir
...
AlcapanaPath="/home/ckampa/coding/AlcapDAQ/analyzer/work/Analyzer2/"
...
echo "$AlcapanaPath/alcapana -i $InFile -o $DataDir/hist0${Run}.root -T $DataDirTree/tree0${Run}.root 2>&1 |tee $DataDir/textOutput$Run > output.txt"
$AlcapanaPath/alcapana -i $InFile -o $DataDir/hist0${Run}.root -T $DataDirTree/tree0${Run}.root 2>&1 |tee $DataDir/textOutput$Run > output.txt
echo "" >> output.txt
