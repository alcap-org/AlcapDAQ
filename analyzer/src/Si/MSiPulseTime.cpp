...
/*-- Module declaration --------------------------------------------*/
INT  MSiPulseTime_init(void);
INT  MSiPulseTime(EVENT_HEADER*, void*);
...
ANA_MODULE MSiPulseTime_module =
{
	"MSiPulseTime",                    /* module name           */
	"Andrew Edmonds",              /* author                */
	MSiPulseTime,                      /* event routine         */
	NULL,                          /* BOR routine           */
	NULL,                          /* EOR routine           */
	MSiPulseTime_init,                 /* init routine          */
	NULL,                          /* exit routine          */
 ...
 */
INT MSiPulseTime(EVENT_HEADER *pheader, void *pevent)
{
