...
double TAnalysedPulse::GetFastPulseAmplitude() const {
...
// -- Gets the amplitude for the fast pulse
// -- Anyone can play around with algorithms in here provided they are on their own branch
double TAnalysedPulse::GetSlowPulseAmplitude() const {
...
double TAnalysedPulse::GetPulseHeight() const {
...
double TAnalysedPulse::GetPulseTime() const {
...
TH1I* TAnalysedPulse::GetPulseWaveform(std::string histname, std::string histtitle) const {
...
int TAnalysedPulse::GetPeakSample() const {
...
// GetPedestal()
// -- Calculates the pedestal for this TAnalysedPulse using the given number of bins
double TAnalysedPulse::GetPedestal(int nPedSamples) const {
