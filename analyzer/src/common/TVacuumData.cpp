...
//double TVacuumData::GetPulseHeight() const {
//
...
//double TVacuumData::GetPulseTime() const {
//
...
//TH1I* TVacuumData::GetPulseWaveform(std::string histname, std::string histtitle) const {
//
...
//int TVacuumData::GetPeakSample() const {
//
...
//
//// GetPedestal()
//// -- Calculates the pedestal for this TVacuumData using the given number of bins
//double TVacuumData::GetPedestal(int nPedSamples) const {
//
