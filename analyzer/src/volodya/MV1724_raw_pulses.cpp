...
Name:         MV1724_raw_pulses
Created by:   Volodya Tishchenko

Contents:     raw pulse histograms for V1724
...
ANA_MODULE MV1724_raw_pulses_module =
{
	"MV1724_raw_pulses",           /* module name           */
...
INT module_bor(INT run_number) {
  ...
  TDirectory *dir = dir0->mkdir("MV1724_raw_pulses");
  dir->cd();

  for (unsigned int i=0; i<NCHAN; i++)
    {
      std::string bankname( Form("D4%02d",i) );
