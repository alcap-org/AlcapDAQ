...
/*-- Module declaration --------------------------------------------*/
INT  MScPulseHeight_init(void);
INT  MScPulseHeight(EVENT_HEADER*, void*);
...
ANA_MODULE MScPulseHeight_module =
{
	"MScPulseHeight",                    /* module name           */
	"Andrew Edmonds",              /* author                */
	MScPulseHeight,                      /* event routine         */
	NULL,                          /* BOR routine           */
	NULL,                          /* EOR routine           */
	MScPulseHeight_init,                 /* init routine          */
	NULL,                          /* exit routine          */
 ...
 */
INT MScPulseHeight(EVENT_HEADER *pheader, void *pevent)
{
			...
			simpleScMapIter++) 
	{
		...
		for (std::vector<TSimpleScPulse*>::iterator scPulse = theScPulses.begin(); scPulse != theScPulses.end(); scPulse++) {
			...
			else
			{
				...
				DetectorToHeightHistMap[detname]->Fill((*scPulse)->GetPulseHeight());
