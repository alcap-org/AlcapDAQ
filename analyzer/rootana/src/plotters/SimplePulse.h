...
SimplePulse() : tpi_id(0), tap_id(0), E(0), Amp(0), tblock(0), tTME(0), bit_mask(0) { }

SimplePulse(Int_t TPIid, Int_t TAPid, Double_t energy, Double_t amplitude, Double_t block_time, Double_t tme_time, Char_t mask) :
  tpi_id(TPIid), tap_id(TAPid), E(energy), Amp(amplitude), tblock(block_time), tTME(tme_time), bit_mask(mask) { };
