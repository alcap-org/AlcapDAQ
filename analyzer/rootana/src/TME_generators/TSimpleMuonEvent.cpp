...
TSimpleMuonEvent::TSimpleMuonEvent(modules::options* opts) : 
...
TSimpleMuonEvent::~TSimpleMuonEvent() { }
...
int TSimpleMuonEvent::BeforeFirstEntry(TGlobalData *gData, TSetupData *gSetup)
{
  char branchname[100];
...
int TSimpleMuonEvent::ProcessEntry(TGlobalData *gData, TSetupData *gSetup)
{
  std::string tmpstr;
...
bool TSimpleMuonEvent::IsMuonHit(TAnalysedPulse * muScPulse)
{
  return (muScPulse->GetAmplitude()>240);
}

AnalysedPulseList TSimpleMuonEvent::GetDetectorPulse(string detname)
{
...
ALCAP_REGISTER_MODULE(TSimpleMuonEvent)
