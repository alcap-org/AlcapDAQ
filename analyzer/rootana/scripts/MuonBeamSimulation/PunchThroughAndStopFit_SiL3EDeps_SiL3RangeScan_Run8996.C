void PunchThroughAndStopFit_SiL3EDeps_SiL3RangeScan_Run8996() {
  ...
  punchAndStop.pdf_params.landau_sigma_max = 500;
  punchAndStop.pdf_params.gauss_sigma_min = 1;
  punchAndStop.pdf_params.gauss_sigma_max = 1000;
  punchAndStop.pdf_params.stop_edep0_min = 5500;
  ...
  punchAndStop.pdf_params.stop_alpha_min = 1.0;//0.00001;
  ...
  punchAndStop.hist_params.histtitle = "SiL3 Energy (Run 8996, SF = 1.30)";
  ...
  filename = "scripts/MuonBeamSimulation/hist_files/SiL3EDepsFromTMETree_SiL3RangeScanDataset_Run8996.root";
  histname = "hSiL3EDeps";
