void PunchThroughAndStopFit_SiTEDeps_Si16a_Run9736() {
  ...
  punchAndStop.hist_params.histtitle = "SiT Energy (Run 9736, SF = 0.99)";
  ...
  std::string filename = "scripts/MuonBeamSimulation/hist_files/SiTEDepsFromTMETree_Si16aDataset_Run9736.root";
