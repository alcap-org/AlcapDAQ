void PunchThroughAndStopFit_SiL1EDeps_Si16a_Run9740() {
  ...
  punchAndStop.hist_params.histtitle = "SiL1 Energy (Run 9740, SF = 1.02)";
  ...
  filename = "scripts/MuonBeamSimulation/hist_files/SiL1EDepsFromTMETree_Si16aDataset_Run9740.root";
  histname = "hSiL1EDeps";
