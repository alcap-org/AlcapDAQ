void PunchThroughFit_SiTEDeps_Si16a_Run9742() {
  ...
  punch.hist_params.histtitle = "SiT Energy (Run 9742, SF = 1.04)";
  ...
  std::string filename = "scripts/MuonBeamSimulation/hist_files/SiTEDepsFromTMETree_Si16aDataset_Run9742.root";
