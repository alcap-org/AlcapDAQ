void PunchThroughAndStopFit_SiL3EDeps_SiL3RangeScan_Run8994() {
  ...
  punchAndStop.hist_params.histtitle = "SiL3 Energy (Run 8994, SF = 1.28)";
  ...
  filename = "scripts/MuonBeamSimulation/hist_files/SiL3EDepsFromTMETree_SiL3RangeScanDataset_Run8994.root";
  histname = "hSiL3EDeps";
