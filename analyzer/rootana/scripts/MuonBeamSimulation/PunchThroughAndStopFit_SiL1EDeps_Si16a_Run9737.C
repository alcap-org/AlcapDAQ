void PunchThroughAndStopFit_SiL1EDeps_Si16a_Run9737() {
  ...
  punchAndStop.hist_params.histtitle = "SiL1 Energy (Run 9737, SF = 0.98)";
  ...
  filename = "scripts/MuonBeamSimulation/hist_files/SiL1EDepsFromTMETree_Si16aDataset_Run9737.root";
  histname = "hSiL1EDeps_wSiL3Hit";
