...
TLatex* BuildDatasetLabel() {
  TLatex* txt = new TLatex(300., 17.0e3, "Si 65#mum");
...
void si16b_norm() {
  TFile* f = new TFile("data/Si16b/nmu_10uspp/nmu.pp10us.root");
  ...
  c->SaveAs("img/cppaper/si16b_norm.png");
}
