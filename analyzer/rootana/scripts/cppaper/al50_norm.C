...
TLatex* BuildNStopLabel() {
  TLatex* txt =
  // new TLatex(336., 30e3, "#splitline{Number of #mu-stops}{163(1)#times10^{6}}");
...
vector<TLatex*> BuildPeakLabels() {
  ...
  labs.push_back(new TLatex(329., 37.0e3, "#muAl 2p-1s"));
...
void al50_norm() {
  TFile* f = new TFile("data/Al50/nmu_10uspp/nmu.pp10us.root");
  ...
  c->SaveAs("img/cppaper/al50_norm.png");
}
