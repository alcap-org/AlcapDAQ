...
void MT_TMELoop() {
  ...
  args.infilename = "~/data/out/v20/MT_SF1-05.root";
  args.outfilename = "~/data/results/MT/subtrees_SF1-05.root";
  TMELoop(args);

  args.infilename = "~/data/out/v20/MT_SF1-025.root";
  args.outfilename = "~/data/results/MT/subtrees_SF1-025.root";
  TMELoop(args);
}
