void SiL3_FinalPlot_Systematic_MuonStopPositions(std::string savedir = "") {
  ...
  if (savedir != "") {
    std::string savename = savedir + "AlCapData_SiL3Dataset_NormalisedSpectrum_MuonStopPositions";
    std::string pdfname = savename + ".pdf";
    c_all_spectra->SaveAs(pdfname.c_str());
    std::string pngname = savename + ".png";
    c_all_spectra->SaveAs(pngname.c_str());
    
    savename = savedir + "AlCapData_SiL3Dataset_Systematic_MuonStopPositions";
