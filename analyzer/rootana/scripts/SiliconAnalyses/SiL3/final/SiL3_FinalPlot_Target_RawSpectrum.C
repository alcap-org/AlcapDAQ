void SiL3_FinalPlot_Target_RawSpectrum(std::string savedir = "") {

  std::string raw_spectra_file_name = "~/data/results/SiL3/raw_spectra_geq1TgtPulse_newPP20us.root";
  std::string full_spectrum_name = "SiL3_ActiveTarget_TimeSlice-200_200/hRawSpectrum";
  std::string cuttree_name = "SiL3_ActiveTarget_TimeSlice-200_200/cuttree";
  ...
  std::string histtitle = "SiL3 Dataset, Target Spectrum, Energy";
  ...
  latex->DrawLatexNDC(0.55, 0.6, text.str().c_str());

  if (savedir != "") {
    std::string savename = savedir + "AlCapData_SiL3Dataset_Target_RawSpectrum";
