void SiL3_FinalPlot_NormalisedSpectrum_wSW_forMu2e(std::string savedir = "") {
  ...
  std::string recoils[n_recoils] = {"allRecoil"};//{"allRecoil"};//, "noRecoil"};
  std::string leglabels[n_recoils] = {"AlCap"};//AlCap (with recoil correction)", "AlCap (without recoil correction)"};
  ...
  */
  ...
  c_log->cd();
  leg->Draw();
  latex->DrawLatexNDC(0.7, 0.5, "AlCap #bf{#it{Preliminary}}");
  ...
  if (savedir != "") {
    std::string savename = savedir + "AlCapData_SiL3Dataset_ActiveTarget_NormalisedSpectrum_wSW_LogY_forJobTalk";
    std::string pdfname = savename + ".pdf";
    c_log->SaveAs(pdfname.c_str());
    std::string pngname = savename + ".png";
    c_log->SaveAs(pngname.c_str());

    savename = savedir + "AlCapData_SiL3Dataset_ActiveTarget_NormalisedSpectrum_wSW_LinY_forJobTalk";
