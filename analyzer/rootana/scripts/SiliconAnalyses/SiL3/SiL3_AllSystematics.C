...
#include "systematics/SiL3_Systematic_DecayElectronCorrection.C"
...
void SiL3_AllSystematics() {
  ...
  std::string infilename = "~/data/results/SiL3/unfold_geq2TgtPulse_newPP20us_2.root";
  std::string outfilename = "~/data/results/SiL3/systematics_geq2TgtPulse_newPP20us_2.root";
  ...
  std::string recoils[n_recoils] = {"noRecoil", "allRecoil", "pRecoil", "aRecoil", "systRecoil"};
  ...
  const int n_ana_time_slices = 3;
  double min_ana_time_slices[n_ana_time_slices] = {2000, 2500, 3000};
  double max_ana_time_slices[n_ana_time_slices] = {4000, 4000, 4000};
  ...
  for (int i_recoil = 0; i_recoil < n_recoils; ++i_recoil) {
    ...
    for (int i_ana_time_slice = 0; i_ana_time_slice < n_ana_time_slices; ++i_ana_time_slice) {
      ...
      SiL3_Systematic_DecayElectronCorrection(infilename, outfilename, countfilename, counttreename, ana_time_slice_str.str(), recoil); // basically the same as the energy miscalibration systemtic
	...
	if (recoil == "allRecoil") {
	  args.syst_val_histnames.push_back("FinalNormalisation_" + ana_time_slice_str.str() + "_pRecoil_" + recoil + "Syst_" + bin_width + "_SystPlot");
	  args.symmetric.push_back(true);
	  args.syst_val_histnames.push_back("FinalNormalisation_" + ana_time_slice_str.str() + "_systRecoil_" + recoil +  "Syst_" + bin_width + "_SystPlot");
	  args.symmetric.push_back(true);
	}
	else if (recoil == "pRecoil") {
	  args.syst_val_histnames.push_back("FinalNormalisation_" + ana_time_slice_str.str() + "_allRecoil_" + recoil + "Syst_" + bin_width + "_SystPlot");
	  args.symmetric.push_back(true);
	  args.syst_val_histnames.push_back("FinalNormalisation_" + ana_time_slice_str.str() + "_systRecoil_" + recoil +  "Syst_" + bin_width + "_SystPlot");
	  args.symmetric.push_back(true);
	}
	else if (recoil == "systRecoil") {
	  args.syst_val_histnames.push_back("FinalNormalisation_" + ana_time_slice_str.str() + "_allRecoil_" + recoil + "Syst_" + bin_width + "_SystPlot");
	  args.symmetric.push_back(true);
	  args.syst_val_histnames.push_back("FinalNormalisation_" + ana_time_slice_str.str() + "_pRecoil_" + recoil +  "Syst_" + bin_width + "_SystPlot");
	  args.symmetric.push_back(true);
	...
	args.syst_val_histnames.push_back("FinalNormalisation_" + ana_time_slice_str.str() + "_" + recoil + "_DecayElec_misCalibUp_" + bin_width + "_SystPlot");
	args.symmetric.push_back(true);
	args.syst_val_histnames.push_back("FinalNormalisation_" + ana_time_slice_str.str() + "_" + recoil + "_DecayElec_misCalibDown_" + bin_width + "_SystPlot");
	args.symmetric.push_back(true);
	...
	single_args.symmetric.clear();
	if (recoil == "allRecoil") {
	  single_args.syst_val_histnames.push_back("FinalNormalisation_" + ana_time_slice_str.str() + "_pRecoil_" + recoil + "Syst_" + bin_width + "_SystPlot");
	  single_args.symmetric.push_back(true);
	  single_args.syst_val_histnames.push_back("FinalNormalisation_" + ana_time_slice_str.str() + "_systRecoil_" + recoil +  "Syst_" + bin_width + "_SystPlot");
	  single_args.symmetric.push_back(true);
	}
	else if (recoil == "pRecoil") {
	  single_args.syst_val_histnames.push_back("FinalNormalisation_" + ana_time_slice_str.str() + "_allRecoil_" + recoil + "Syst_" + bin_width + "_SystPlot");
	  single_args.symmetric.push_back(true);
	  single_args.syst_val_histnames.push_back("FinalNormalisation_" + ana_time_slice_str.str() + "_systRecoil_" + recoil +  "Syst_" + bin_width + "_SystPlot");
	  single_args.symmetric.push_back(true);
	}
	...
	single_args.syst_val_histnames.clear();
	single_args.symmetric.clear();
	single_args.syst_val_histnames.push_back("FinalNormalisation_" + ana_time_slice_str.str() + "_" + recoil + "_DecayElec_misCalibUp_" + bin_width + "_SystPlot");
	single_args.symmetric.push_back(true);
	single_args.syst_val_histnames.push_back("FinalNormalisation_" + ana_time_slice_str.str() + "_" + recoil + "_DecayElec_misCalibDown_" + bin_width + "_SystPlot");
	single_args.symmetric.push_back(true);
	single_args.outdirname = "FinalSystPlot_DecayElec_" + ana_time_slice_str.str() + "_" + recoil + "_" + bin_width;
	Systematic_FinalPlot(single_args);
      }
    }
  }  
