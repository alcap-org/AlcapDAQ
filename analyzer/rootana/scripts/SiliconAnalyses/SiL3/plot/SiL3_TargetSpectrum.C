...
void SiL3_TargetSpectrum(std::string infilename, std::string outfilename) {
  ...
  double recoil_fractions[n_recoils] = {0, -190, particle_recoils[0], particle_recoils[1], particle_recoils[2], particle_recoils[3], allRecoil, lowAllRecoil, highAllRecoil};
