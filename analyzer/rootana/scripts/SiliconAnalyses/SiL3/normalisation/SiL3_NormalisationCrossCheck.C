...
void SiL3_NormalisationCrossCheck() {
  ...
  //  double min_slice = 2000;
  //  double max_slice = 6000;
  //  double slice_step = 100;
  //  const int n_slices = 40;
  double min_slice = 4000;
  double max_slice = 5000;
  double slice_step = 1000;
  //  double min_slice = 2000;
  //  double max_slice = 10000;
  //  double slice_step = 8000;
  ...
  for (double i_muon_slice_start = min_slice; i_muon_slice_start < max_slice; i_muon_slice_start += slice_step) {
    ...
    std::string direct_dirname = "TargetSpectrum_forCrossCheck_" + muon_slice.str();
    ...
    std::string indirect_dirname = "GeLoGain_wSiL3Coinc_" + muon_slice.str();
    //    std::string indirect_dirname = "XRaySpectrum_GeLoGain_noTimeCut";
  ...
  gre->Draw("A*E");
  gre->SetTitle("Efficiency Comparisons (SiL3 Dataset)");
  ...
  for (int i_ref_eff = 0; i_ref_eff < n_ref_efficiencies; ++i_ref_eff) {
    ...
    FillGeEffParams("GeLoGain", ge_eff_runs[i_ref_eff], a, b, delta_a, delta_b, corr);
