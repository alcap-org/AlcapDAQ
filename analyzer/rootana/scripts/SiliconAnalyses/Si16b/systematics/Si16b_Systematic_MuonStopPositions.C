...
void Si16b_Systematic_MuonStopPositions(std::string infilename, std::string outfilename,
  ...
  std::string positions[n_positions] = {"", "_higherE", "_lowerE"};
  ...
  for (int i_position = 0; i_position < n_positions; ++i_position) {
    ...
    std::string outdirname = "ResponseMatrix_" + particle_name + "_" + pid + "_MuStopPos" + position;
    ...
    outdirname = "FinalNormalisation_" + particle_name + "_" + pid + "_MuStopPos" + position;
