...
void Si16b_Unfold_DecayElectronCorrection(std::string infilename, std::string outfilename) {
  ...
  args.inhistname = "FlatBackground/hCorrectedSpectrum";
  ...
  args.corrfilename = "~/data/mc/Si16b_passive/R15b_Si16b-InclusiveAnalysis_MCCorrections_1M.root";
  ...
  args.countfilename = "~/data/results/Si16b_passive/normalisation.root";
