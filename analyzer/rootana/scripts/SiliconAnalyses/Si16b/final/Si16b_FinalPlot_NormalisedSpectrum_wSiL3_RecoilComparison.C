void Si16b_FinalPlot_NormalisedSpectrum_wSiL3_RecoilComparison(std::string savedir = "") {
  ...
  std::string leglabels_Si16b[n_settings] = {"Si16b (sum)"};
  ...
  if (savedir != "") {
    std::string savename = savedir + "AlCapData_NormalisedSpectra_RecoilComparison";
