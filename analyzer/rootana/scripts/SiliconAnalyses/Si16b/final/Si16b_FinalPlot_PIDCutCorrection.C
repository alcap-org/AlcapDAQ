void Si16b_FinalPlot_PIDCutCorrection() {
  ...
  std::string indirname = "PIDCut_" + particle + "_PSel";
  ...
  */
  ...
  leg->AddEntry(hFoldedSpectrum, "before PID correction", "l");
  leg->AddEntry(hUnfoldedSpectrum, "after PID correction", "l");
  //  leg->Draw();
  
  TLatex* latex = new TLatex();
  latex->DrawLatexNDC(0.55, 0.85, "AlCap Preliminary");
