void Si16b_FinalPlot_TimeResolutionsSimple2() {
  ...
  std::string third_channel = "SiT_4";
  ...
  for (int i_pair = 0; i_pair < n_pairs; ++i_pair) {
    ...
    std::string cutcmd = "( (@SiR1_1.size()==1 || @SiR1_2.size()==1 ||@SiR1_3.size()==1 || @SiR1_4.size()==1) && @" + second_channel + ".size()==1 && @" + third_channel + ".size()==1 && ((SiR1_1.E>500 && SiR1_1.E<1000) || (SiR1_2.E>500 && SiR1_2.E<1000) || (SiR1_3.E>500 && SiR1_3.E<1000) || (SiR1_4.E>500 && SiR1_4.E<1000)) && SiR2.E<2000)";
