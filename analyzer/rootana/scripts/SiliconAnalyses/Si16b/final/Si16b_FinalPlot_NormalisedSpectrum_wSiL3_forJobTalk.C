void Si16b_FinalPlot_NormalisedSpectrum_wSiL3_forJobTalk(std::string savedir = "") {
  ...
  for (int i_recoil = 0; i_recoil < n_recoils; ++i_recoil) {
    ...
    SiL3_hist->GetXaxis()->SetTitleOffset(1.0);
  ...
  if (savedir != "") {
    std::string savename = savedir + "AlCapData_NormalisedSpectra_forJobTalk";
