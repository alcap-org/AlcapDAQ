void Si16b_FinalPlot_SiR2Inc_FlatBkgCorrection() {
  ...
  for (double i_min_time_slice = min_time_slice; i_min_time_slice < max_time_slice; i_min_time_slice += time_slice_step) {
    ...
    std::string foldername = "SiR2_FlatBkg_" + time_slice_str.str();
    ...
    raw_spectrum->SetTitle("Si16b Dataset, SiR2 Inclusive Analysis, Flat Background Correction");
