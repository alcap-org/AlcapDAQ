void Si16b_FinalPlot_MuonSpot_ThickTime() {
  ...
  for (int i_cut = 0; i_cut < n_cuts; ++i_cut) {
    std::string histname = "muspot_" + cutnames[i_cut] + "_SiR/hThickTime_12not3";
    ...
    hTime->SetTitle("Si16b Dataset, Muon Spots, Thick Time");
