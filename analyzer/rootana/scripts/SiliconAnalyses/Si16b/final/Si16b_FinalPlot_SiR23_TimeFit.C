void Si16b_FinalPlot_SiR23_TimeFit() {
  ...
  TH1D* hTime = hEnergyTime->ProjectionX("Si16b", min_energy_bin, max_energy_bin);
  ...
  TF1* lifetime_fit = new TF1("lifetime_fit", equation.c_str(), 0, 20000);
  lifetime_fit->SetParameters(1000, 100, 1000);
