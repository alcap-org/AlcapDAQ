void Si16b_FinalPlot_TwoLayer_EvdE_TCutG_2sigma_forJobTalk(std::string savedir = "", std::ostream& numbers_file = std::cout) {
  ...
  latex->SetTextSize(0.04);
  latex->DrawLatexNDC(0.6, 0.75, "#pm2#sigma Selection");
  ...
  if (savedir != "") {
    std::string savename = savedir + "AlCapData_Si16bDataset_TwoLayer_EvdE_TCutG_2sigma_forJobTalk";
