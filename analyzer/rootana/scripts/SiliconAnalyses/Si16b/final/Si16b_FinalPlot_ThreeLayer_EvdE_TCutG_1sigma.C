void Si16b_FinalPlot_ThreeLayer_EvdE_TCutG_1sigma(std::string savedir = "") {
  ...
  for (int i_particle = 0; i_particle < n_particles; ++i_particle) {
    ...
    std::string tcutgname = this_particle + "3L_SiR_timecut0_10000ns_layerCoinc/r_sir3_hLg_SiR_EvDeltaE_" + this_particle + "_1sigma_keV";
  ...
  if (savedir != "") {
    std::string savename = savedir + "AlCapData_Si16bDataset_ThreeLayer_EvdE_TCutG_1sigma";
