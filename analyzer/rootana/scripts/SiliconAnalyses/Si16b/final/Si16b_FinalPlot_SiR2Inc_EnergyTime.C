void Si16b_FinalPlot_SiR2Inc_EnergyTime() {

  std::string plots_file_name = "~/data/results/Si16b/plots.root";
  std::string full_spectrum_name = "SiR2/hEnergyTime";
  ...
  std::string histtitle = "Si16b Dataset, SiR2 Inclusive Analysis, Energy vs Time";
