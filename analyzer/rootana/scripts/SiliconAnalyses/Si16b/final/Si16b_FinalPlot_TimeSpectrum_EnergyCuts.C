void Si16b_FinalPlot_TimeSpectrum_EnergyCuts() {
  ...
  TH1F* hFitVsCut = new TH1F("hFitVsCut", "Fitted Lifetime (expo + pol1) vs Energy Cut", n_bins,min_energy_cut,max_energy_cut);
  ...
  for (double i_min_energy_cut = min_energy_cut; i_min_energy_cut < max_energy_cut; i_min_energy_cut += energy_cut_step) {
    ...
    std::string base_indirname = "SiL3_" + energy_cut_str.str() + "keVCut_wFlatBkg";
    ...
    std::string histtitle = "Si16b Dataset, SiL3, E > " + energy_cut_str.str() + "keV Cut";
    ...
    std::string pngname = "~/plots/2018-11-06/AlCapData_Si16bDataset_Lifetime_" + energy_cut_str.str() + "keVCut.png";
