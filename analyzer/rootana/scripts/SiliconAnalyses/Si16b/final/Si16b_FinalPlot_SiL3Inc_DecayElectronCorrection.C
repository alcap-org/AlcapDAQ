void Si16b_FinalPlot_SiL3Inc_DecayElectronCorrection() {
  ...
  for (double i_min_time_slice = min_time_slice; i_min_time_slice < max_time_slice; i_min_time_slice += time_slice_step) {
    ...
    std::string foldername = "SiL3_DecayElectron_" + time_slice_str.str();
    ...
    raw_spectrum->SetTitle("Si16b Dataset, SiL3 Inclusive Analysis, Decay Electron Correction");
