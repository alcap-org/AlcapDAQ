void Si16b_FinalPlot_Active_EscapeCorrection() {
  ...
  std::string dirname = "CombinedEscape_Active";
  ...
  leg->AddEntry(hInputSpectrum, "w/Decay Electron Removal", "l");
  //  leg->AddEntry(hCorrection, "Escape Correction", "l");
  leg->AddEntry(hCorrectedSpectrum, "w/Escape Correction", "l");
  leg->Draw();
}
