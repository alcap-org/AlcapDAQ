void Si16a_FinalPlot_DataVsMC_BeamEnergy_Thick_wVeto() {
  /*  
  const int n_runs = 8;
  ...
  */
  ...
  int rebin_factors[n_settings] = {10, 4};
  std::string inhistnames[n_settings] = {"Thick_wThin_TimeSlice-200_200/hRawSpectrum", "hThickEnergy_Veto_SiL"};
