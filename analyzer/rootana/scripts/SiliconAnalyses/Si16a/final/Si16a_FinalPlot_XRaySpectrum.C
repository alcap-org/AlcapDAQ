void Si16a_FinalPlot_XRaySpectrum() {

  std::string plots_file_name = "~/data/results/Si16a/plots09743_newPP.root";
  std::string ge_channel = "GeHiGain";
  std::string full_spectrum_name = ge_channel + "/hEnergyTime";
  std::string norm_file_name = "/home/edmonds/data/results/Si16a/normalisation09743_newPP.root";
  std::string norm_ws_name = "XRaySpectrum_" + ge_channel + "_wTimeCut/ws";
  ...
  hXRaySpectrum->SetTitle("Si16a Dataset, Run XXXX, Full X-Ray Spectrum");
