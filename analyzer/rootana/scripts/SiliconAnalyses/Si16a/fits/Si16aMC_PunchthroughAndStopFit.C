...
void Si16aMC_PunchthroughAndStopFit(std::string infilename, std::string outfilename, bool add_punchthrough) {
  ...
  args.inhistname = "hSiL1All";
  args.outdirname = "SiL1";
