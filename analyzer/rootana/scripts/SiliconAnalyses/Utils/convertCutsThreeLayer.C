void convertCutsThreeLayer() {

  //  std::string filename = "~/data/results/Si16b/mark-al50-sir3-cuts.root";
  std::string filename = "~/data/results/Si16b/mark-si16b-sir3-cuts.root";
  TFile* file = new TFile(filename.c_str(), "READ");

  //  std::string outfilename = "~/data/results/Si16b/mark-al50-sir3-cuts-keV.root";
  std::string outfilename = "~/data/results/Si16b/mark-si16b-sir3-cuts-keV.root";
  TFile* outfile = new TFile(outfilename.c_str(), "RECREATE");

  TIter next(file->GetListOfKeys());
  TKey *key;
  double pdt_cutoff = 40.0;
