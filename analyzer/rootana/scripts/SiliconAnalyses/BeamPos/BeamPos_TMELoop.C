...
void BeamPos_TMELoop() {
  ...
  for (int i_run = 0; i_run < n_runs; ++i_run) {
    ...
    run_str << run_number;
    TMELoopArgs args;
    args.infilename = "~/data/out/local/out" + run_str.str() + "_tme-tree.root";
    args.tmetreename = "TMETree/TMETree";
    args.outfilename = "~/data/results/BeamPos/subtrees" + run_str.str() + "_newPP.root";
    ...
    // Target - Layer 2
    args.target.layer2_channels.push_back(&empty);
    args.target.layer2_calibGains.push_back(0);
    args.target.layer2_calibOffsets.push_back(0);
    ...
    /*args.sit.layer2_channels.push_back(&SiL1_2);
      args.sit.layer2_channels.push_back(&SiL1_3);
      args.sit.layer2_channels.push_back(&SiL1_4);
      args.sit.layer2_channels.push_back(&SiL1_5);
      args.sit.layer2_channels.push_back(&SiL1_6);
      args.sit.layer2_channels.push_back(&SiL1_7);
      args.sit.layer2_channels.push_back(&SiL1_8);
      args.sit.layer2_channels.push_back(&SiL1_9);
      args.sit.layer2_channels.push_back(&SiL1_10);
      args.sit.layer2_channels.push_back(&SiL1_11);
      args.sit.layer2_channels.push_back(&SiL1_12);
      args.sit.layer2_channels.push_back(&SiL1_13);
      args.sit.layer2_channels.push_back(&SiL1_14);
      args.sit.layer2_channels.push_back(&SiL1_15);
      args.sit.layer3_channels.push_back(&SiL3);
    */
    //  args.sit.layer2_channels.push_back(&empty);
    //  args.sit.layer3_channels.push_back(&empty);
