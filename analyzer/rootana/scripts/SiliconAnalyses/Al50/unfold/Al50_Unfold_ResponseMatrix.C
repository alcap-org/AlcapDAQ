#ifndef Al50_Unfold_ResponseMatrix_
#define Al50_Unfold_ResponseMatrix_

#include "../..//Utils/Unfold_ResponseMatrix.C"

void Al50_Unfold_ResponseMatrix(std::string infilename, std::string outfilename, std::string datahistname, std::string mcfilename, std::string mcresponsename, double bin_width_val, /*int rebin_factor,*/ std::string outdirname, double highE_cut = 10000, /*double n_gen_events,*/ std::string method = "bayes", int reg_parameter = 4) {
