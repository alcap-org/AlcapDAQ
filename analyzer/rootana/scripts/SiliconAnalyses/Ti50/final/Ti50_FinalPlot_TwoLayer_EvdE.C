void Ti50_FinalPlot_TwoLayer_EvdE() {
  ...
  std::string dirname;
  if (arm == "Right") {
    dirname = "all_SiR_timecut0_10000ns_layerCoinc"; layer1 = "SiR1"; layer2 = "SiR2"; layer3 = "SiR3";
  }
  else if (arm == "Left") {
    dirname = "all_SiL_timecut0_10000ns_layerCoinc"; layer1 = "SiL1"; layer2 = "SiL3"; layer3 = "SiL2";
  }
  else {
