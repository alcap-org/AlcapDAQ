void Ti50_FinalPlot_EvdE() {
  ...
  std::string histtitle = "Ti50 Dataset, Right Arm, Two Layer Plot (" + layer1 + " && " + layer2 + ")";
  ...
  histtitle = "Ti50 Dataset, Right Arm, Two Layer Plot (" + layer1 + " && " + layer2 + " && " + layer3 + ")";
  ...
  histtitle = "Ti50 Dataset, Right Arm, Three Layer Plot (" + layer1 + " && " + layer2 + " && " + layer3 + ")";
